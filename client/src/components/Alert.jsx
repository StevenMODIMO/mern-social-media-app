...
export default function Alert() {
  ...
  return (
    showAlert && showAgain && (
      <div className="fixed top-16 w-72 p-4 m-6 right-0 text-sm bg-gray-100 border border-gray-300 rounded-md shadow-md">
        <h1 className="text-lg font-semibold mb-2">Alert, Hi!</h1>
